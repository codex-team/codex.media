...
class Kohana_RouteTest extends Unittest_TestCase
{
    ...
    public function test_constructor_returns_if_uri_is_null()
    {
        ...
        $route = $this->getMock('Route', ['_compile'], [], '', false);
    ...
    public function test_matches_returns_false_on_failure($uri, $match)
    {
        ...
        $stub = $this->getMock('Request', ['uri'], [$match]);
    ...
    public function test_matches_returns_array_of_parameters_on_successful_match($uri, $m, $c, $a)
    {
        ...
        $request = $this->getMock('Request', ['uri'], [$m]);
     ...
     * @param mixed $c
     * @param mixed $a
     * @param mixed $test_uri
     * @param mixed $test_uri_array
     * @param mixed $default_uri
     */
    public function test_defaults_are_used_if_params_arent_specified($uri, $regex, $defaults, $c, $a, $test_uri, $test_uri_array, $default_uri)
    {
        ...
        $request = $this->getMock('Request', ['uri'], [$default_uri]);
        $request->expects($this->any())
            ->method('uri')
     ...
     *
     * @param mixed $uri
     * @param mixed $matches_route1
     * @param mixed $matches_route2
     */
    public function test_required_parameters_are_needed($uri, $matches_route1, $matches_route2)
    {
        ...
        $request = $this->getMock('Request', ['uri'], ['']);
        $request->expects($this->any())
            ->method('uri')
        ...
        $request = $this->getMock('Request', ['uri'], [$matches_route1]);
        $request->expects($this->any())
            ->method('uri')
        ...
        $request = $this->getMock('Request', ['uri'], [$matches_route2]);
        $request->expects($this->any())
            ->method('uri')
     ...
     * @param mixed $uri
     * @param mixed $regex
     * @param mixed $target_uri
     * @param mixed $uri_params
     */
     ...
     * @param mixed $uri
     * @param mixed $regex
     * @param mixed $uri_string1
     * @param mixed $uri_array1
     * @param mixed $uri_string2
     * @param mixed $uri_array2
     */
    ...
    public function test_route_filter_modify_params($route, $defaults, $filter, $uri, $expected_params)
    {
        ...
        // Mock a request class
        $request = $this->getMock('Request', ['uri'], [$uri]);
        $request->expects($this->any())
            ->method('uri')
