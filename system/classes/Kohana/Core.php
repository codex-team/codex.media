...
class Kohana_Core
{
    ...
    /**
     * @var bool True if [magic quotes](http://php.net/manual/en/security.magicquotes.php) is enabled.
     */
    ...
    /**
     * @var bool Has the file path cache changed during this execution?  Used internally when when caching is true in [Kohana::init]
     */
