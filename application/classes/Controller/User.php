...
class Controller_User extends Controller_Base_preDispatch
{
    ...
    public function action_profile()
    {
        ...
        switch ($act) {
        	case 'rise'    : $this->view['success'] = $viewUser->setUserStatus($this::USER_STATUS_TEACHER); break;
        	case 'ban'     : $this->view['success'] = $viewUser->setUserStatus($this::USER_STATUS_BANNED); break;
        	case 'degrade' :
        	case 'unban'   : $this->view['success'] = $viewUser->setUserStatus($this::USER_STATUS_STUDENT); break;
        }
