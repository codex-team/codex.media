<article class="article article--wide island island--padded" itemscope itemtype="http://schema.org/Article">
    ...
    <header class="article__information">
        ...
        <a class="site-head clear" href="/">
            <span class="site-head__logo" data-placeholder="<?= mb_substr($site_info['title'], 0, 1, "UTF-8"); ?>">
        ...
        <div class="article__information-right">
            ...
            <a class="article__author" href="/user/<?= $page->author->id ?>" itemscope itemtype="http://schema.org/Person" itemprop="author">
                ...
                <span class="article__author-name" itemprop="name"><?= $page->author->name ?></span>
            </a>
