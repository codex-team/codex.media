...
<div class="island tabs island--margined">
    <a class="tabs__tab tabs__tab--bolder <?= $list == 'pages' || !$list ? 'tabs__tab--current tabs__tab--red' : '' ?>" href='/user/<?= $viewUser->id ?>'>
        Блог
    </a>
    <a class="tabs__tab tabs__tab--bolder <?= $list == 'comments' ? 'tabs__tab--current tabs__tab--red' : '' ?>" href='/user/<?= $viewUser->id ?>/comments'>
        Комментарии
    </a>
</div>
