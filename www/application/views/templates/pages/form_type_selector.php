...
<div class="form-type-selector">
    <div class="form-type-selector__content">
        ...
        <div class="form-type-selector__item js-form-type-selector__item">
            ...
            <input type="radio" class="js-page-type" name="type" value="<?= Controller_Page_Modify::BLOG ?>" id="isPersonalBlog">
            <label for="isPersonalBlog">Блог</label>
        </div>

        <? if ($user->isAdmin()): ?>
            <div class="form-type-selector__item js-form-type-selector__item">
                <input type="radio" name="type" id="isNews" value="<?= Controller_Page_Modify::NEWS ?>">
                    <? include(DOCROOT . 'public/app/svg/news-icon.svg'); ?>
                <label for="isNews">Новость</label>
            </div>

            <div class="form-type-selector__item js-form-type-selector__item">
                <input type="radio" name="type" id="isPage" value="<?= Controller_Page_Modify::PAGE ?>">
                <? include(DOCROOT . 'public/app/svg/page-icon.svg'); ?>
                <label for="isPage">Страница</label>
            </div>

            <div class="form-type-selector__item js-form-type-selector__item">
                <input type="radio" name="type" id="isEvent" value="<?= Controller_Page_Modify::EVENT ?>">
        ...
        <div class="form-type-selector__item js-form-type-selector__item">
            <input type="radio" name="type" id="isCommunity" value="<?= Controller_Page_Modify::COMMUNITY ?>">
